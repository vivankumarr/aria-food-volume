...
DEPTH_FROM_STEREO_DIR = "/kaggle/working/depth_from_stereo"  # Meta depth from stereo directory
FOUNDATION_STEREO_DIR = DEPTH_FROM_STEREO_DIR + "/FoundationStereo"
FOUNDATION_STEREO_CKPT = "/kaggle/input/datasets/vivankumarr/foundationstereo-checkpoint/model_best_bp2.pth"
